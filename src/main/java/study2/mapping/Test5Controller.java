...
public class Test5Controller extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("com : " + com); -- 각각 하나하나가 Command 객체가 됨
...
//		String viewPage = "/WEB-INF/study2/mapping"+com+".jsp";
		...
		if(com.equals("/test5")) {
			...
			int dan = (request.getParameter("dan").equals("") || request.getParameter("dan")==null) ? 1 : Integer.parseInt(request.getParameter("dan"));
