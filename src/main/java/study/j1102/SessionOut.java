...
public class SessionOut extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!sw.equals("test4_init")) {
			response.sendRedirect(request.getContextPath()+"/study/1102_web.xml/test3_init.jsp");
		}
		else {
			response.sendRedirect(request.getContextPath()+"/study/1102_web.xml/test4_init.jsp");
		}
