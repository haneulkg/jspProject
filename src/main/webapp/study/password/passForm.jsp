		  	...
		  	<table class="table table-bordered">
				...
				<tr>
				  	<td colspan="2" class="text-center">
					    <input type="button" value="숫자비번" onclick="pwdCheck(1)" class="btn btn-primary mr-2" />
					    <input type="button" value="혼합비번" onclick="pwdCheck(2)" class="btn btn-success mr-2" />
					    <input type="button" value="SHA256" onclick="pwdCheck(3)" class="btn btn-info mr-2" />
