...
<!-- 		<div><a href="javascript:history.back();" class="btn btn-secondary">돌아가기</a></div> -->
		<%-- <div><a href="adminMemberList?pag=${pag}&pageSize=${pageSize}&Vlevel=${Vlevel}" class="btn btn-secondary">돌아가기</a></div> --%>
		<div><a href="adminMemberList.ad?pag=${pag}&pageSize=${pageSize}" class="btn btn-secondary">돌아가기</a></div>
	</div>
	<p><br/></p>
</body>
</html>